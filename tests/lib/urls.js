...
class URLs {
    ...
    connector_country() { return process.env.TESTS_CON_COUNTRY; }
    connector_heritage_natural() { return process.env.TESTS_CON_HERITAGE_NAT; }
    connector_heritage_cultural() { return process.env.TESTS_CON_HERITAGE_CULT; }

    connector_country_webhook(id) { return this.connector_country() + `/entity/country/${id}`}
    connector_country_ts_webhook(id, tsid) { return this.connector_country() + `/timeseries/country/${id}/${tsid}`}
    connector_heritage_natural_webhook(id) { return this.connector_heritage_natural() + `/entity/heritagesites/${id}`}
    connector_heritage_cultural_webhook(id) { return this.connector_heritage_cultural() + `/entity/heritagesites/${id}`}
}
